...
//#define USE_MATRIX_EXP_EVOLUTION
...
/** ===== Set Maximum Fidelity Cutoff ============================== */

#define MAX_FIDELITY_CUTOFF 0.99999
...
double BFGS_Optimization::phi(double& a){
    ...
    alphaPosition = position + a * p;
        ...
        meritFunction.setU(alphaPosition,eps);
...
double BFGS_Optimization::minimize(){
    ...
    funcDimension = meritFunction.funcDimension;
        ...
        meritFunction.setU(position,eps);
    ...
    while(true){
        ...
        #ifdef MAX_FIDELITY_CUTOFF

            if(-stepMonitor > MAX_FIDELITY_CUTOFF) break;

        #endif // MAX_FIDELITY_CUTOFF
...
void BFGS_Optimization::setGradient(){
            ...
            meritFunction.setMatrixExpGradient(gradient,stepMonitor,eps);

            for(int i=0;i<meritFunction.constantVariables;i++){
        ...
        meritFunction.setGRAPEGradient(position,gradient);
